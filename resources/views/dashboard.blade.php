...
<div class="jumbotron">
   <div class="card align-items-center justify-content-center">
        <div class="card-body">
            <div style="background-color: #a0bfe0; height: 5px; width: 50px; margin-bottom: 10px;"></div>
                    ...
                    @if(count($fotos) > 0)
                        @foreach($fotos as $foto)
                            <div class="col-md-2 mb-3">
                                <div class="card" style="width: 100%; background-color: #ecf0f1; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3);">
